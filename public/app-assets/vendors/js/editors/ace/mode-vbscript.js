...
var VBScriptHighlightRules = function() {
    ...
    "start": [
        ...
        },
        {
            ...
            regex: "\\b(?:TotalBytes|Buffer|CacheControl|Charset|ContentType|Expires|ExpiresAbsolute|IsClientConnected|PICS|StatusLeads|ScriptTimeout|CodePage|LCID|SessionID|Timeout)\\b",
            caseInsensitive: true
        },
        {
