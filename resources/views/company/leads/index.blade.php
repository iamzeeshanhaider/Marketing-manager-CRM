...
@section('content')
    ...
    <section class="" style="overflow-x: auto">
        ...
        <x-table.lead-datatables :headings="['', 'id', 'company', 'details', 'created_at', 'lead_status', 'action']" title="Leads" :subtitle="(optional($company)->name ? 'Showing Leads for ' . $company->name . '<br>' : '') .
            (optional($status)->name ? 'Showing Leads with ' . $status->name . 'Status' : '')">

            <x-slot name="addons">
                <input type="submit" class="btn btn-primary" value="Check All" id="select-all-button">
