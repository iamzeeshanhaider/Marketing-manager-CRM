<div class="chat-container">
                        ...
                        <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-2">
                                                    <h6 class="list-group-item-heading">
                                                        {{ optional($conversation->agent)->name }}
                                                        <br>
                            ...
                            <div id="collapse-{{ $index }}" role="tabpanel"
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! optional($conversation->campaign)->email_content ?? $conversation->comment !!}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="chat-form collapse fade {{ canEngageWithLead($lead->id) ? 'show' : 'hide' }}">
        <div class="card border-0">
            ...
            @if ($show_form)
                <div>
                    <form wire:submit.prevent="saveComment()" class="card-body pb-1">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="content">Content</label>
                                <textarea wire:model="comment" id="content" rows="5"
                        ...
                        <div class="text-right small">
                            <button class="btn btn-primary btn-sm" type="submit" wire:loading.attr="disabled">
                                <i class="ft-navigation"></i> Save Comment
                            </button>
                        </div>
                    </form>
                </div>
